...
# Despite the various reciprocation code, it still seems to mathematically make
# the most sense to always be a miser, even with lots of presents initially and lots
# of folks.
...
FOLKS = (1..MANY).map { |number|
    {
        ...
        presents: 20,  # They all have a little something laying around
        got_from: {},
        gave_to: {},
    }
}
