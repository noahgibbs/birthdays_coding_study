...
# In this one, I'm ordering by how many presents they wind up with. Short
# version is that being stingy wins - reciprocal and friendly are both
# bad if you want presents. Increasing the number of people doesn't change
# that. What if there's very little friendly and a lot of reciprocal, though?
# (Quick check) Nope, that doesn't help either.
